 ...
 */	  
       ...
       $stmt = $conn->prepare("INSERT INTO funcionario (nome,cpf,rg,cep,numero,celular,email, dataAdmissao,uf,rua,bairro) VALUES (:nome,:cpf,:rg,:cep,:numero,:celular,:email,:dataAdmissao,:uf,:rua,:bairro)");
